package Algorithms.Arrays.kth_largest_in_arr;

import java.util.Random;

public class Main {
    public int quickselect(int[] arr, int k) throws Exception {
    /*
    ...
    */
        ...
        while (left <= right) {
            int chosenPivotIndex = rand.nextInt(right - left + 1) + left; // Pick a random pivot. Bounds are [left, right].
    ...
    */
    ...
    /*
      ...
      (where the chosen pivot value is now sitting in safety)
    */
